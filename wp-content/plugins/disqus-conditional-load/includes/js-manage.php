...
<div id="jspro" class="wrap jspro-settings">
	...
	<h2> <?php _e( 'Disqus Conditional Load' ); ?> : <?php _e( 'Basic Settings'); ?></h2>
...
if ( isset($_POST['reset']) ) {
	...
	delete_option('type');
	delete_option('js_button');
	delete_option('js_class');
	delete_option('js_message');
	delete_option('js_shortcode');
	delete_option('js_count_disable');
    unset($_POST);
    dsq_reset_database();
?>
<div class="wrap">
