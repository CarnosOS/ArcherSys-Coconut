...
function gmpGetMapImgSrc(map) {
	//center=46.9750330,31.9945830&zoom=16&size=600x400&maptype=roadmap&sensor=false&language=&markers=color:red|label:none|46.9750330,31.9945830&markers=color:green|label:none|46.9750910,31.9945930
	var reqParams = {
	...
	var reqStr = 'http://maps.google.com/maps/api/staticmap?'+ jQuery.param(reqParams);
